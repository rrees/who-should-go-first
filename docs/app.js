...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		var message = _p0._0;
		var seed = _p0._1;
		return A2(_user$project$Main$Model, message, seed);
	});
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('decider'),
				_elm_lang$html$Html_Events$onClick(_user$project$Main$NewMethod)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('decider--messaage')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
