				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: 'Most recently ill',
								_1: {
									ctor: '::',
									_0: 'Closest upcoming birthday',
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$methodGenerator = A2(
	...
	_elm_community$random_extra$Random_Array$sample(_user$project$Main$methods));
var _user$project$Main$Model = F2(
	function (a, b) {
		return {message: a, seed: b};
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Random$step, _user$project$Main$methodGenerator, model.seed);
		var message = _p0._0;
		var seed = _p0._1;
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Main$Model, message, seed),
...
var _user$project$Main$init = {
	...
	_0: A2(
		...
		_user$project$Main$defaultMessage,
		_elm_lang$core$Random$initialSeed(15000)),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$NewMethod = {ctor: 'NewMethod'};
var _user$project$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('decider'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$NewMethod),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('decider--messaage'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
